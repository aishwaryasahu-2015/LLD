...
import LowLevelDesign.Splitwise.Group.Group;
...
public class Splitwise {
    ...
    public void demo(){
        ...
        splits.add(split2);
        splits.add(split3);
        group.createExpense("Breakfast", 900, splits, ExpenseSplitType.EQUAL, userController.getUser("U1001"));
        ...
        group.createExpense("Lunch", 500, splits2, ExpenseSplitType.UNEQUAL, userController.getUser("U2001"));
